...
assert.equal(r.regions.reduce((n,region)=>n+region.animals.reduce((a,b)=>a+b,0),0),r.animals);
assert.equal(r.regions.reduce((n,region)=>n+region.seeds,0),r.seedBank);
assert.equal(r.families.reduce((n,f)=>n+f.accessibleFood+f.stranded,0),r.animals);
