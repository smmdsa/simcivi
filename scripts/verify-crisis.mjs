...
run(120);phases.push({name:'Before crisis',...state()});forceWeather(sim,5,39);run(90);phases.push({name:'Hot drought',...state()});assert(sim.recovery.totals.plantSleeps>0);assert(sim.recovery.totals.animalSleeps>0);assert(phases[1].dormant>phases[0].dormant);assert(sim.creatures.length>0);
