...
Actualizado: 24 de septiembre de 2026. IV.7.1 sigue en diagnóstico; el trabajo espacial y visual de rendimiento está integrado.
...
- [ ] **ECO-01 · Corridas reproducibles.** Ejecutar las semillas 1726312000000 y 1726312000001 durante 150 días con paso 0,1, igual al worker. Agregar tres semillas declaradas antes de correr. Guardar revisión de código, configuración, métricas diarias y checkpoints por tramos; reanudar sin repetir avances. Los resultados existentes de 10 días a 0,2 son exploratorios, no una comparación controlada.
  ...
  Instrumentación y [manifiesto fijo de cinco semillas](verification/ecology-seeds.json) preparados. Las cinco llegaron al día 21: 1.322–1.754 animales; Rubrón fue la única familia animal extinguida. [Resultados y límites](V4-ECOLOGY-DIAGNOSTIC.md). Se perfiló un checkpoint de 1.169 animales y se comprobó igualdad de estado después de 100 pasos; la [pasada de rendimiento](V4-PERFORMANCE-PASS.md) añade regulación del canal worker y ajustes visuales. Los cinco checkpoints del día 20 se migraron al código actual tras comprobar igualdad exacta del estado completo durante 1.600 pasos por semilla, con prueba de procedencia; se reanudaron al día 21. Los guardados posteriores son diarios. ECO-01 permanece abierta: continuar las cinco series hasta el día 150.
...
La siguiente tarea ejecutable es completar ECO-01: reanudar desde los checkpoints validados hasta 150 días y perfilar cargas de 1.000–4.000 animales. Luego ECO-02 investiga Rubrones y la pérdida de variedades vegetales sin presuponer un colapso general.
