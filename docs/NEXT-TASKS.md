...
Actualizado: 23 de septiembre de 2026. IV.7.1 sigue en diagnóstico; el trabajo espacial y visual de rendimiento está integrado.
...
- [ ] **ECO-01 · Corridas reproducibles.** Ejecutar las semillas 1726312000000 y 1726312000001 durante 150 días con paso 0,1, igual al worker. Agregar tres semillas declaradas antes de correr. Guardar revisión de código, configuración, métricas diarias y checkpoints por tramos; reanudar sin repetir avances. Los resultados existentes de 10 días a 0,2 son exploratorios, no una comparación controlada.
  ...
  Instrumentación y [manifiesto fijo de cinco semillas](verification/ecology-seeds.json) preparados. Las cinco llegaron al día 20: 1.162–1.546 animales; Rubrón fue la única familia animal extinguida. [Resultados y límites](V4-ECOLOGY-DIAGNOSTIC.md). Se perfiló un checkpoint de 1.169 animales y se comprobó igualdad de estado después de 100 pasos; la [pasada de rendimiento](V4-PERFORMANCE-PASS.md) añade regulación del canal worker y ajustes visuales. ECO-01 permanece abierta: revalidar los checkpoints con el nuevo hash de código y continuar hasta 150 días.
...
La siguiente tarea ejecutable es completar ECO-01: perfilar cargas de 1.000–4.000 animales, revalidar los checkpoints anteriores con igualdad de estado y continuar hasta 150 días. Luego ECO-02 investiga Rubrones y la pérdida de variedades vegetales sin presuponer un colapso general.
