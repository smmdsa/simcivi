...
**IV.7.1 en curso:** cinco semillas declaradas, censo diario ampliado, comparación a paso 0,1 y checkpoints reanudables. [Resultados parciales y migración validada](V4-ECOLOGY-DIAGNOSTIC.md): supervivencia general de los animales, extinción de Rubrones como única familia animal en las cinco semillas y crecimiento acuático que aumenta el coste de simulación. Los checkpoints del día 20 se compararon durante 1.600 pasos con el código original y el actual, con estados completos idénticos en las cinco semillas. La [primera pasada de rendimiento](V4-PERFORMANCE-PASS.md) conserva el estado determinista y regula el envío de estados a la vista. Siguen pendientes las corridas a 150 días, el diagnóstico causal y mediciones de FPS en navegador. No se declara cerrada.
